...
interface State {
  ...
  mapLoaded: boolean;
  ownPositionMarker: any;
  webviewErrorMessages: string[];
}

export default class WebViewLeaflet extends React.Component<Props, State> {
  ...
  doPostMapLoadedActions = () => {
    ...
    let onMapLoadedUpdate: MapLoadedUpdate = {
